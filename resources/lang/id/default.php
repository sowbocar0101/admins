...
// ====A+P+P+K+E+Y====
    return [
        ...
        'sidenav'=>[
            ...
            'data_order' => 'Pesanan',
            'driver' => 'Pengemudi',
            'driver-tracking' => 'Lacak Pengemudi',
            'user' => 'Pengguna',
        ...
        'text'=>[
            ...
            'logout' => 'Keluar',
            'edit-profile' => 'Ubah Informasi Admin',
            'show' => 'Tampilan',
    ...
    *Tambahkan gambar baru dan hapus gambar lama',
        ...
        'table'=>[
            ...
            'min-km' => 'Jarak minimal（KM）',
            'min-price' => 'Harga minimal',
            'seat' => 'Kursi',
            'harga-tambahan' => 'Harga tambahan',
            'min-m' => 'Jarak minimal（m)'
        ],
        //Validation
        'validation' => [
            'required' => 'Keperluan',
        ...
        'new' => [
            ...
            'admin' => [
                ...
                'title-edit' => 'Ubah Admin',
                'sub-title-edit' => 'Ubah admin',
            ...
            'driver' => [
                ...
                'title-edit' => 'Ubah informasi driver',
                'sub-title-edit' => 'ubah informasi driver',
            ...
            'user' => [
                ...
                'title-edit' => 'Ubah Pengguna',
                'sub-title-edit' => 'Ubah Pengguna',
            ...
            'order' => [
                ...
                'pending' => 'Menunggu Diterima Driver',
                'driver_accept' => 'Diterima Driver',
                'departure_to_customer' => 'Berangkat ke lokasi customer',
                'arrival_to_customer' => 'Sampai di lokasi customer',
                'customer_confirmation' => 'Menunggu konfirmasi customer',
                'departure_to_destination' => 'Berangkat ke lokasi tujuan',
                'arrival_to_destination' => 'Sampai di lokasi tujuan',
                'complete' => 'Selesai',
                'cancel' => 'Dibatalkan',
            ...
            'price-setting' => [
                ...
                'title-edit' => 'Ubah harga',
                'sub-title-edit' => 'Ubah harga',
            ...
            'about-us' => [
                ...
                'title-edit' => 'Ubah Tentang Kami',
                'sub-title-edit' => 'Ubah Tentang Kami',
            ],
        ],
    ];
