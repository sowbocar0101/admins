...
// ====A+P+P+K+E+Y====
    return [
        'order_setting' => 'Show Order Setting',
        'order_setting_title' => 'Order Setting',
        'order_setting_breadcrumb' => 'Order Setting Configuration',
        'min_price_discount' => 'Min Price Discount',
        'discount' => 'Discount',
        'night_service' => 'Late Night Service',
        'app_name' => 'TAXI APP',
        'login'=>[
    ...
    *Insert new image and delete old image',
        ...
        'table'=>[
            ...
            'car_model' => 'Car Model',
            'min-km' => 'Minimum distance（KM）',
            'min-price' => 'Minimum price',
            'seat' => 'Seat',
            'harga-tambahan' => 'Additional price',
            'min-m' => 'Minimum distance（m)',
        ...
        'new' => [
            ...
            'order' => [
                ...
                'departure_to_customer' => 'Departure to customer',
                'arrival_to_customer' => 'Arrival at customer',
                'customer_confirmation' => 'Waiting customer confirmation',
                'departure_to_destination' => 'Departure to destination',
                'arrival_to_destination' => 'Arrival at destination',
                'complete' => 'Done',
                'cancel' => 'Canceled',
